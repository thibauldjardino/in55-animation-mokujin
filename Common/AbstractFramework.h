...
public:
    ...
    /*!
    *\brief Recalcule la matrive de modele en multipliant l'actuelle matrice
    * par la matrice passee en parametre.
    */
    virtual void applyMatrix( QMatrix4x4 transformation ) =0;
};
...
#define ABSTRACT_FRAMEWORK_INTERFACE \
    ...
    void applyMatrix( QMatrix4x4 transformation ); \
